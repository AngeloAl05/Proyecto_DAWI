...
public class GeneroServiceImpl implements GeneroService {
    ...
    @Override
    public GeneroResponseDTO buscarXID(Long id) {
        return generoRepository.findById(id).map(generoMapper::toDTO).orElseThrow(()-> new RuntimeException("no se encontro el id: " + id));
    }
}
